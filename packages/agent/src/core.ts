      ...
      if (msg.tool_calls && msg.tool_calls.length > 0) {
        ...
        for (const tc of msg.tool_calls) {
          ...
          if (!tool) {
            ...
            this.emit({ type: "observation", content: errMsg, toolName: tc.function.name, toolCallId: tc.id });
            continue;
          }
          ...
          try {
            ...
            this.emit({ type: "observation", content: result, toolName: tc.function.name, toolCallId: tc.id });
          } catch (e: any) {
