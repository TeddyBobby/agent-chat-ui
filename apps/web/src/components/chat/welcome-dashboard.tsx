...
export function WelcomeDashboard({ onNewChat, onFocusInput, onCreativeImage, onAttachFile }: WelcomeDashboardProps) {
  return (
    <div className="relative min-h-0 flex-1 overflow-y-auto">
      ...
      <div className="absolute left-1/2 top-[484px] flex h-[44px] w-[688px] origin-top -translate-x-1/2 gap-[16px] min-[1200px]:max-[1439px]:scale-[0.78] max-[900px]:scale-[0.72]">
        {FILES.map((file) => (
          <button
            type="button"
